...
public class BaseInfoActivity extends AppCompatActivity {
    ...
    private void initView() {
        commonTitleBtn = (Button) findViewById(R.id.common_title_btn);
    ...
    public Button GetRightButton() {
        commonTitleBtn.setVisibility(View.VISIBLE);
        return commonTitleBtn;
    }
    ...
    public void onBackClickListener(View.OnClickListener onClickListener){
        commonTitleTb.setNavigationOnClickListener(onClickListener);
    };
