...
public interface GWApi {
    ...
    void postFindpicBytype(@Query("ukey") String ukey,@Query("type") int type, Callback2<LunbotuResponse> callback2);
    @POST("/notice/findNoticeByType")//获取根据 type 获取notice
    void postFindNoticeBytype(@Query("ukey") String ukey,@Query("type") int type, Callback2<DanmuResponse> callback2);
